...
function initializeCarousels() {
  ...
  const carousels = [
    ...
    { id: "#newproduct-carousel", options: { loop: true, margin: 15, nav: true, dots: false, navText: getNavText(), responsive: { 0: { items: 1 }, 400: { items: 2 }, 768: { items: 3.5 }, 960: { items: 3.8 }, 1200: { items: 4.9 } } } },
    { id: "#popular-durex-carousel", options: { loop: true, margin: 15, nav: true, dots: false, navText: getNavText(), responsive: { 0: { items: 1 }, 400: { items: 2 }, 768: { items: 3.5 }, 960: { items: 3.8 }, 1200: { items: 4.9 } } } },
